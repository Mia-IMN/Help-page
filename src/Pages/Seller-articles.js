...
export const Seller = [
    {
        ...
        header: `Promotional Advertising You've Waited For`,
    ...
    },
    {
        ...
        header: 'Understanding How to Sell your housie',
        text: `Maybe you've heard these different marketing terms, maybe you haven't. Either way, let me help to clarify the difference between them...`,
        cName: 'articles'
    },
    {
        image: <img src={Rectangle2} className="image"/>,
        header: 'Myspace Layouts, The Missing Element',
        text: `Maybe you've heard these different marketing terms, maybe you haven't. Either way, let me help to clarify the difference between them...`,
        cName: 'articles'
    },
    {
        image: <img src={Rectangle6} className="image"/>,
        header: 'From Wetlands To Canals And Amsterdam',
        text: `Maybe you've heard these different marketing terms, maybe you haven't. Either way, let me help to clarify the difference between them...`,
        cName: 'articles'
    },
    {
        image: <img src={Rectangle4} className="image"/>,
        header: 'Importance Of Material Choice In Home',
        text: `Maybe you've heard these different marketing terms, maybe you haven't. Either way, let me help to clarify the difference between them...`,
        cName: 'articles'
    }
]